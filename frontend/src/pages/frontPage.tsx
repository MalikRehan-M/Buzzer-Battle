        ...
        <div className="front-page-container"> {/* Use className to apply CSS class */}
            ...
            <div className="button-container">
                ...
                <div className="button-wrapper">
                    ...
                    >
                        {selectedOption? `Categories : ${selectedOption}` : "Select Category"}
                    </button>
                    {isDropdownOpen && (
                         <div className="dropdown">
                         <ul>
                           <li onClick={() => handleOptionSelect("Entertainment")}>Entertainment</li>
                           <li onClick={() => handleOptionSelect("Technical")}>Technical</li>
